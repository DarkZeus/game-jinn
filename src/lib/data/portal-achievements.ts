// Portal 2 achievements data extracted from Steam Web API
export const PORTAL_2_ACHIEVEMENTS = [
	{
		apiname: "ACH.SURVIVE_CONTAINER_RIDE",
		achieved: 1,
		unlocktime: 1435148863,
		name: "Wake Up Call",
